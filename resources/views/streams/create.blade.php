        ...
        <div class="my-1">
                <label class="block mt-4 text-sm">
                    ...
                    <select name="classes_id" id="select" class="block w-full text-sm border-r-2 border-gray-950 dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                        ...
                        <option value="{{$class->id}}">{{$class->name}}, {{$class->branches->name}}</option>
                        @endforeach
                    </select>
                </label>
                @error('classes_id')
            ...
            <div class="my-4">
                <label class="block text-sm">
                    ...
                    <input name="name" placeholder="E.g., West" value="{{old('name')}}" class="block w-full mt-1 text-sm h-10 outline-8  dark:border-gray-900  dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" />
                </label>
                @error('name')
                <div class="text-red-500">{{ $message }}</div>
                @enderror
