        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800 grid grid-cols-1 md:grid-cols-2 gap-2 ">
            ...
            <div class="my-4">
                <label class="block text-sm">
                    ...
                    <input name="name" placeholder="E,g Class green" value="{{$class->name}}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" />
                </label>
                @error('stream_id')
                <div class="text-red-500">{{ $message }}</div>
                @enderror
