...
<div class="flex justify-between items-center mr-5 mt-5">
    ...
    <a href="{{route('roles.create')}}" class="bg-purple-500 text-white px-4 py-2 rounded text"> <i class="fas fa-user-edit"></i> Add role</a>
</div>
<section class="px-4">
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center space-x-4 text-sm">
                                <div class="col-sm">
                                    <a href="{{ route('roles.edit', $role->id) }}" class=" p-2 pr-3 bg-transparent hover:bg-purple-600 hover:text-white cursor-pointer dark:bg-gray-700 dark:hover:bg-purple-600 dark:text-gray-300 dark:hover:text-white"> 
                                        <i class="fa fa-edit mx-1"></i>Edit
                                    </a>
                                </div>
                                <div class="col-sm">
                                    <button data-id="{{ $role->id }}" class="deleteBtn  p-2 bg-transparent hover:bg-red-500 hover:text-white cursor-pointer dark:bg-gray-700 dark:hover:bg-red-500 dark:text-gray-300 dark:hover:text-white">
                        ...
                        <div id="deleteModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
                            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-1/3">
                                ...
                                <div class="mt-4 flex items-center">
                                    ...
                                    <p class="dark:text-gray-300">Are you sure you want to delete this role?</p>
                                </div>
